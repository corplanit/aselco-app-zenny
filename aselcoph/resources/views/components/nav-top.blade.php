     ...
     <div class="main-header-container container-fluid">
         <div class="header-content-left">
             <div class="header-element">
                 <div class="horizontal-logo">
                     <a href="/u/dashboard" class="header-logo"></a>
                 </div>
             </div>
             ...
             <div class="header-element header-menu-search">
                 <button type="button" class="header-search-trigger" id="menu-search-open" aria-haspopup="dialog" aria-controls="menu-search-modal">
         ...
         <ul class="header-content-right">
             ...
             <li class="header-element">
                 <div class="header-theme-toggle" role="group" aria-label="Color theme">
                     <a href="javascript:void(0);" data-hs-theme-click-value="light" title="Light mode" aria-label="Light mode">
                         <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" fill="none"
                             viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                             <path stroke-linecap="round" stroke-linejoin="round"
                                 d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
                         </svg>
                     </a>
                     <a href="javascript:void(0);" data-hs-theme-click-value="dark" title="Dark mode" aria-label="Dark mode">
                         <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" fill="none"
                             viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                             <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @include('components.ticket-notification-bell')
             ...
             <li class="header-element">
                 <a href="/user/profile" class="header-link" title="Settings">
