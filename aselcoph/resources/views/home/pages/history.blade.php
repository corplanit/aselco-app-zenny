...
<body class="theme-lima">
    ...
    <div class="breadcumb-wrapper pb-5" data-bg-src="/assets/home/img/bg/hero_bg_4.png?t">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">History</h1>
                <ul class="breadcumb-menu">
                    <li><a href="home-hr-management.html">History</a></li>
                    <li>Historical Records and Files</li>
                </ul>
            </div>
        </div>
    </div>

    @include('home.pages.partials.tabs')
